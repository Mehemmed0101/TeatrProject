            ...
            do
            {
                ...
                else if (command.ToLower().Equals("add seans"))
                {
                    var seans = new Seans
                    {
                        ...
                        SeansTime = DateTime.Parse("2/25/2023 17:00:00 PM"),
                        Price = 8,
                    };
                    ...
                    var seans1 = new Seans
                    {
                        ...
                        SeansTime = DateTime.Parse("2/25/2023 13:30:00 PM"),
                        Price = 10,
                    };
                    ...
                    var seans2 = new Seans
                    {
                        ...
                        SeansTime = DateTime.Parse("2/25/2023 8:00:00 PM"),
                        Price = 8,
                    };
